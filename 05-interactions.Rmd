...
Figures \@ref(fig:interactions-all) and \@ref(fig:interactions-all2) below show all the interaction affects between both numerical and categoriacal variables.
