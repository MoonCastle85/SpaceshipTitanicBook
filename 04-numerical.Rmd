...
```{r explore-name-counts, results = "hide", warning = FALSE, message = FALSE, fig.cap = "Exploration of the counts of the LastName variable where LastNameCount is the number of passengers in total that share the same last name while LastNamesPerGroup is the number of passengers that share last name within a group."}
df1 <- train6 %>%
...
```{r smooth-age, results = "hide", fig.cap="General additive model (GAM) plots for Age with smoothed confidence intervals. The red dotted line shows the average probability of the response across the entire training set."}
...
```{r smooth-passengergroup, results = "hide", fig.cap="General additive model (GAM) plots for PassengerGroup with smoothed confidence intervals. The red dotted line shows the average probability of the response across the entire training set."}
...
```{r smooth-cabinnumber, results = "hide", fig.cap = "General additive model (GAM) plots for CabinNumber with smoothed confidence intervals. The red dotted line shows the average probability of the response across the entire training set."}
...
```{r smooth-lastname, results = "hide", fig.cap = "General additive model (GAM) plots for LastNameAsNumber with smoothed confidence intervals. The red dotted line shows the average probability of the response across the entire training set."}
...
```{r roomservice, results = "hide", fig.cap = "General additive model (GAM) plots for RoomService with smoothed confidence intervals. The red dotted line shows the average probability of the response across the entire training set."}
my_smooth_plot(train6 %>% filter(CryoSleep == "False"), "RoomService")
```

```{r vrdeck, results = "hide", fig.cap = "General additive model (GAM) plots for VRDeck with smoothed confidence intervals. The red dotted line shows the average probability of the response across the entire training set."}
my_smooth_plot(train6 %>% filter(CryoSleep == "False"), "VRDeck")
```

```{r spa, results = "hide", fig.cap = "General additive model (GAM) plots for Spa with smoothed confidence intervals. The red dotted line shows the average probability of the response across the entire training set."}
...
```{r shoppingmall, results = "hide", fig.cap = "General additive model (GAM) plots for ShoppingMall with smoothed confidence intervals. The red dotted line shows the average probability of the response across the entire training set."}
my_smooth_plot(train6 %>% filter(CryoSleep == "False"), "ShoppingMall")
```

```{r foodcourt, results = "hide", fig.cap = "General additive model (GAM) plots for FoodCourt with smoothed confidence intervals. The red dotted line shows the average probability of the response across the entire training set."}
...
```{r totalspent, results = "hide", fig.cap = "General additive model (GAM) plots for TotalSpent with smoothed confidence intervals. The red dotted line shows the average probability of the response across the entire training set."}
