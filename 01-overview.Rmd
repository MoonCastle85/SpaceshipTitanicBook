...
```{r frequencies, results = "hide", animation.hook = "gifski", interval = 1.5, fig.cap = "Distribution of the variables against the response"}
...
train %>%
  na.omit(.) %>%
plot_correlation(., type = "all", theme_config = list(text = element_text(size = 20), axis.text.x = element_text(angle = 90)))
```
