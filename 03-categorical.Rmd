...
```{r correspondence-dest-deck, results = "hide", fig.cap = "Correspondance analysis of Destination and Deck variables."}
...
```{r correspondence-home-deck, results = "hide", fig.cap = "Correspondance analysis of HomePlanet and Deck variables."}
...
```{r binom-passgrp, warning = FALSE, results = "hide", message = FALSE, fig.cap = "PassengerGroupSize plotted as a binomial plot with confidence intervals. The red dotted line shows the average probability of the response across the entire training set."}
...
```{r binom-destgrp, warning = FALSE, results = "hide", message = FALSE, fig.cap = "DestinationsPerGroup plotted as a binomial plot with confidence intervals. The red dotted line shows the average probability of the response across the entire training set."}
...
```{r VIP-binom, warning = FALSE, results = "hide", message = FALSE, fig.cap="A closer look at the VIP variable and its relation to the response."}
...
```{r VIP-variable, warning = FALSE, results = "hide", message = FALSE, fig.cap="A closer look at VIP and VIPsPerGroup against the response."}
g1 <- train5 %>%
