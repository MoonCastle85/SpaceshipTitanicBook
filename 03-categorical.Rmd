...
# mosaic_slick <- map(1:length(mosaic_plots), .f = \(i) paste0("Mosaic", i, ".png"))
# save(mosaic_slick, file = "Mosaic slick plots.RData")

load("Mosaic slick plots.RData")
...
# binom_slick <- map(1:length(binom_plots), .f = \(i) paste0("Binomial", i, ".png"))
# save(binom_slick, file = "Biomial slick plots.RData")

load("Biomial slick plots.RData")
